                        ...
                        return [
                            ...
                            'variants' => $variants->map(function ($variant) use ($priceFormat) {
                                return [
                                    ...
                                    'title' => $variant['title'],
                                    'price' => isset($variant['price']) && !is_null($variant['price']) ? $this->formatMoney($variant['price'], $priceFormat) : "",
            ...
            $filteredNodes = collect($nodes)
                ...
                ->map(function ($node) use ($variantIds, $priceFormat, $utm_source, $redirectValue, $user) {
                    ...
                    return [
                        ...
                        'price' => isset($node['price']) && !is_null($node['price']) ? $this->formatMoney($node['price'], $priceFormat) : "",
