...
const ThreeItemGridReverse = lazy(() =>
    import("./PDFLayout/ThreeItemGridReverse")
);
...
const PDFPreview = (props) => {
    ...
    // const paperLayout = 'a4';

    let innerPagePadding = "20px";
    if (headerText !== "" && footerText !== "") innerPagePadding = "38px 20px";
    else if (headerText !== "") innerPagePadding = "38px 20px 20px";
    else if (footerText !== "") innerPagePadding = "20px 20px 38px";

    if (frontImage !== "") {
        frontImage =
            frontImage.indexOf("data:image") > -1
                ? frontImage
                : `${IMAGE_PREFIX}uploads/frontImage/${frontImage}`;
    ...
    if (backImage !== "") {
        backImage =
            backImage.indexOf("data:image") > -1
                ? backImage
                : `${IMAGE_PREFIX}uploads/backImage/${backImage}`;
    ...
    let {
        width: pdfWidth = 21,
        height: pdfHeight = 29.7,
        convertHeight = 0,
    } = convertPaperSize(paperLayout, pdfLayout);
    pdfWidth = "100%";
    const pageSize = getCurrentPDFPageSize(
        productPageLayoutId,
        selectedProducts
    );
    ...
    const {
        [`${paperLayout}_${productPageLayoutId}`]: {
            main: extraHeight = 0,
            sub: childExtraHeight = 0,
            isFrontImg = 0,
            extraFrontImg = 0,
        } = {},
    } = autoPDFSize();
    ...
    console / console.log("pdf preview paperlayout : ", paperLayout);
                ...
                >
                    {frontImage !== "" && (
                        <FrontImage
                            ...
                            backgroundColor={props.configData.backgroundColor}
                        />
                    )}
                    {/* Start Product Layout */}
                    {productPageLayoutId === "oneItemGrid" && (
                        <OneItemGrid
                    ...
                    {productPageLayoutId === "twoItemGrid" && (
                        <TwoItemGrid
                    ...
                    {productPageLayoutId === "twoItemList" && (
                        <TwoItemList
                            isShowFront={isShowFront}
                            isShowBack={isShowBack}
                            childExtraHeight={childExtraHeight}
                    ...
                    {productPageLayoutId === "twoItemLeftList" && (
                        <TwoItemLeftList
                            isShowFront={isShowFront}
                            isShowBack={isShowBack}
                            childExtraHeight={childExtraHeight}
                    ...
                    {productPageLayoutId === "twoItemRightList" && (
                        <TwoItemRightList
                            isShowFront={isShowFront}
                            isShowBack={isShowBack}
                            childExtraHeight={childExtraHeight}
                    ...
                    {productPageLayoutId === "threeItemGrid" && (
                        <ThreeItemGrid
                            childExtraHeight={childExtraHeight}
                            innerPagePadding={innerPagePadding}
                            pdfWidth={pdfWidth}
                    ...
                    {productPageLayoutId === "threeItemGridReverse" && (
                    ...
                    {productPageLayoutId === "threeItemList" && (
                        <ThreeItemList
                            childExtraHeight={childExtraHeight}
                            innerPagePadding={innerPagePadding}
                            pdfWidth={pdfWidth}
                    ...
                    {productPageLayoutId === "threeItemLeftList" && (
                        <ThreeItemLeftList
                            childExtraHeight={childExtraHeight}
                            innerPagePadding={innerPagePadding}
                            pdfWidth={pdfWidth}
                    ...
                    {productPageLayoutId === "threeItemRightList" && (
                        <ThreeItemRightList
                            childExtraHeight={childExtraHeight}
                            innerPagePadding={innerPagePadding}
                            pdfWidth={pdfWidth}
                    ...
                    {productPageLayoutId === "fourItemGrid" && (
                        <FourItemGrid
                            childExtraHeight={childExtraHeight}
                            innerPagePadding={innerPagePadding}
                            pdfWidth={pdfWidth}
                    ...
                    {productPageLayoutId === "fourItemList" && (
                        <FourItemList
                            childExtraHeight={childExtraHeight}
                            innerPagePadding={innerPagePadding}
                            pdfWidth={pdfWidth}
                    ...
                    {productPageLayoutId === "fourItemLeftList" && (
                        <FourItemLeftList
                            childExtraHeight={childExtraHeight}
                            innerPagePadding={innerPagePadding}
                            pdfWidth={pdfWidth}
                    ...
                    {productPageLayoutId === "fourItemRightList" && (
                        <FourItemRightList
                            childExtraHeight={childExtraHeight}
                            innerPagePadding={innerPagePadding}
                            pdfWidth={pdfWidth}
                    ...
                    {productPageLayoutId === "fiveItemGrid" && (
                        <FiveItemGrid
                            childExtraHeight={childExtraHeight}
                            innerPagePadding={innerPagePadding}
                            pdfWidth={pdfWidth}
                    ...
                    {productPageLayoutId === "fiveItemList" && (
                        <FiveItemList
                            childExtraHeight={childExtraHeight}
                            innerPagePadding={innerPagePadding}
                            pdfWidth={pdfWidth}
                    ...
                    {productPageLayoutId === "sixItemList" && (
                        <SixItemList
                            childExtraHeight={childExtraHeight}
                            innerPagePadding={innerPagePadding}
                            pdfWidth={pdfWidth}
                    ...
                    {productPageLayoutId === "eightItemGrid" && (
                        <EightItemGrid
                            childExtraHeight={childExtraHeight}
                            innerPagePadding={innerPagePadding}
                            pdfWidth={pdfWidth}
                    ...
                    {productPageLayoutId === "tenItemGrid" && (
                        <TenItemGrid
                            childExtraHeight={childExtraHeight}
                            innerPagePadding={innerPagePadding}
                            pdfWidth={pdfWidth}
