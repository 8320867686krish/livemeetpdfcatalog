...
const ThreeItemList = ({ customClass = "", productPageLayoutId = "", onClick = () => { } }) => {
    return (
        <div className={`page_layout_item${productPageLayoutId === 'threeItemList' ? ' active' : ''}`} onClick={customClass !== "" ? () => { } : () => onClick('threeItemList', 'productPageLayoutId')}>
