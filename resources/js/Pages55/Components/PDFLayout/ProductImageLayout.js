...
const ProductImageLayout = (data = {}) => {
    let { productImage = "", productAttributes = [], barcode = "", backgroundSize = pdfBackgroundImgSize, backgroundPosition = "top" } = data;
        ...
        <div className="slot-row top img-container ">
            {productImage !== ''
                ...
                <div style={{ overflow: "hidden", width: "100%", height: "100%", position: "relative" }}>
                    <div style={{ width: "100%", height: "100%", backgroundSize: 'contain', backgroundImage: "url(" + productImage + ")", backgroundRepeat: "no-repeat", backgroundPosition: backgroundPosition, transform: "translate(0px, 0px) scale(1)" }}>
                    </div>
                    {(productAttributes.includes('barcode') && barcode !== null && barcode !== '') &&
                ...
                :
                <div className="slot-placeholder hover-indicator" style={{ opacity: "0.4", width: "100%", height: "100%", textAlign: "center", fontSize: "36px", fontFamily: "sans-serif" }}></div>
            }
        </div>
    )
}
