                        ...
                        <div className="inner-page" style={{ padding: innerPagePadding, backgroundColor: backgroundColor, height: "100%", width: "100%", fontFamily: fontFamily, color: fontColor, overflow: "hidden" }}>
                            ...
                            <div className="container">
                                {productItem.map(pItem => {
                                    ...
                                    return (
                                        <div key={`product_${id}`} className="row" style={{ height: "50%", margin: "10px", backgroundColor: productBackgroundColor, color: productAttributeLabelColor }}>
                                ...
                                {productItem.length < displayPerPageProduct &&
                                    [...Array(displayPerPageProduct - productItem.length)].map((x, i) => {
                                        return (
                                            <div key={`blank_product_${i}`} className="row" style={{ height: "50%", margin: "10px" }}>
                                                <div style={{ display: "flex", flex: "1 1 auto", flexDirection: "column" }}>
                                                    <ProductImageLayout />
                                                </div>
                                            </div>
