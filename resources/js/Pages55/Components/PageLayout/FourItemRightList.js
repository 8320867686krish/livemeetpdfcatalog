...
const FourItemRightList = ({ customClass = "", productPageLayoutId = "", onClick = () => { } }) => {
    return (
        <div className={`page_layout_item${productPageLayoutId === 'fourItemRightList' ? ' active' : ''}`} onClick={customClass !== "" ? () => { } : () => onClick('fourItemRightList', 'productPageLayoutId')}>
