                                            ...
                                            <Grid>
                                                ...
                                                <Grid.Cell columnSpan={{ xs: 12, sm: 12, md: 12, lg: 12, xl: 12 }}>
                                                    ...
                                                    <Suspense fallback={<Spinner accessibilityLabel="Small spinner example" size="large" />}>
                                                        <ProductList catalogId={settingId} productLimit={catelog_product_limit} shopid={shopid} selectedResources={selectedProducts} parentStateUpdateByChild={updateStateByChild} collectionId={collectionId} fetchedProduct={true} />
                                                    </Suspense>
                                                </Grid.Cell>
                                            </Grid>
                                        </LegacyCard>
