!(function (e) {
        ...
        return (
          ...
          (i = [
            ...
            },
            {
              ...
              value: function (e, t) {
                var i = this.app,
                  o = i.provider,
                  a = t.pageNumber,
                  s = r.ifdef(t.textureTarget, n.a.TEXTURE_TARGET.VIEWER),
            ...
            { key: "finalizeTextContent", value: function () {} },
            {
              ...
              value: function () {
                var e = this,
                  t = (e.stageDOM = r.ifdef(e.stageDOM, e.parentElement[0]));
                t &&
                  (t.addEventListener(
                    "mousemove",
            ...
            },
            {
              key: "setPage",
              value: function (e) {
                r.log("Set Page detected", e.pageNumber);
    ...
    var a,
      ...
      h = (s.utils = {
        ...
        getSharePrefixes: function () {
          return (
            s.defaults.sharePrefix + ",dflip-,flipbook-,dearflip-,dearpdf-"
          )
            .split(",")
            .filter(function (e) {
              return e;
        ...
        getScript: function (e, t, i) {
          ...
          function a() {
            n.removeEventListener("load", r, !1),
              n.removeEventListener("readystatechange", r, !1),
              n.removeEventListener("complete", r, !1),
          ...
          if (0 === jQuery("script[src='" + e + "']").length) {
            ...
            (n.async = !0),
              ...
              n.addEventListener("complete", r, !1),
              i && n.addEventListener("error", s, !1),
        ...
        prefix:
          ...
          {
            dom: "WebKit|Moz|MS".match(new RegExp("(" + r + ")", "i"))[1],
            lowercase: r,
            css: "-" + r + "-",
        ...
        pan: function (e, t) {
          ...
          (e.left = Math.ceil(h.limitAt(a, -e.shiftWidth, e.shiftWidth))),
            (e.top = Math.ceil(h.limitAt(r, -e.shiftHeight, e.shiftHeight))),
            ...
            if (
              ...
              null != o && (o = o.split("/")[0]),
                ...
                t.length > 0 &&
                  ...
                  (null != t.data("lightbox") ||
                    (null != t.attr("href") &&
                      t.attr("href").indexOf(".pdf") > -1)) &&
                    t.trigger("click"),
    ...
    (h.getOptions = function (e) {
      ...
      var n = (function (e) {
        ...
        return (
          ...
          (t.id = e.attr("id")),
          (t.openPage = e.data("page")),
          (t.pageMode = e.attr("pagemode")),
          t
        );
      })(e);
      ...
      (h.parseInt = function (e) {
        return parseInt(e, 10);
      }),
      (h.parseFloat = function (e) {
        return parseFloat(e);
      }),
      (h.parseIntIfExists = function (e) {
        return void 0 !== e && (e = parseInt(e, 10)), e;
      }),
      (h.parseFloatIfExists = function (e) {
        return void 0 !== e && (e = parseFloat(e)), e;
      }),
      (h.parseBoolIfExists = function (e) {
        return void 0 !== e && (e = h.isTrue(e)), e;
      }),
      (h.sanitizeOptions = function (e) {
        return (
          (e.paddingLeft = h.parseIntIfExists(e.paddingLeft)),
          (e.paddingRight = h.parseIntIfExists(e.paddingRight)),
          (e.paddingTop = h.parseIntIfExists(e.paddingTop)),
          (e.paddingBottom = h.parseIntIfExists(e.paddingBottom)),
          (e.duration = h.parseIntIfExists(e.duration)),
          (e.rangeChunkSize = h.parseIntIfExists(e.rangeChunkSize)),
          (e.maxTextureSize = h.parseIntIfExists(e.maxTextureSize)),
          (e.linkTarget = h.parseIntIfExists(e.linkTarget)),
          (e.zoomRatio = h.parseFloatIfExists(e.zoomRatio)),
          (e.enableAnalytics = h.parseBoolIfExists(e.enableAnalytics)),
          (e.autoPlay = h.parseBoolIfExists(e.autoPlay)),
          (e.autoPlayStart = h.parseBoolIfExists(e.autoPlayStart)),
          (e.autoPlayDuration = h.parseIntIfExists(e.autoPlayDuration)),
          void 0 !== e.loadMoreCount &&
            ((e.loadMoreCount = h.parseInt(e.loadMoreCount)),
      ...
      (n.a.parseNormalElements = function () {
        ...
        jQuery(".df-element").each(function () {
          var t = jQuery(this);
          if ("true" !== t.attr("skip-parse") && "true" !== t.data("parsed")) {
            t.data("parsed", "true"), t.attr("df-parsed", "true");
            var i = t.data("lightbox");
            if (void 0 === i) t.dearviewer();
            else if ((t.addClass("df-popup-" + i), "thumb" === i)) {
              var o = t.data("thumb-layout") || n.a.defaults.thumbLayout,
                a = h.httpsCorrection(t.data("thumb"));
              t.removeAttr("data-thumb").removeAttr("data-thumb-layout");
              var r = t.html().trim();
              if (
                ((void 0 !== r && "" !== r) || (r = "Click to Open"),
                !0 === n.a.defaults.displayLightboxPlayIcon &&
                  t.addClass("df-icon-play"),
                "custom" !== o)
              ) {
                t.html("");
                var s = jQuery("<span class='df-book-title'>").html(r),
                  l = jQuery("<div class='df-book-wrapper'>").appendTo(t),
                  u = jQuery("<div class='df-book-cover'>")
                    .append(s)
                    .appendTo(l);
                (null != a && "" != a.toString().trim()) ||
                  (t.addClass("df-thumb-not-found"),
                  (a = n.a.defaults.imagePlaceholder || e));
                var c = jQuery('<img alt="' + r + '"/>');
                c.attr("src", a), u.append(c);
              }
              "book-title-hover" != o && t.addClass("df-tl-" + o);
            }
          }
        });
      }),
            ...
            { key: "determineHeight", value: function () {} },
            {
              ...
              value: function () {
                ...
                var e = this,
                  ...
                  r = t.options.icons;
                (o.sound = v
                  .createBtn("sound", r.sound, a.toggleSound)
                  .on("click", function () {
            ...
            },
            {
              ...
              value: function () {
                var e = this.app,
                  ...
                  n = !1,
                  o = !1;
                (t < this.minZoom && (t = this.maxZoom = this.minZoom),
            ...
            },
            {
              ...
              value: function () {
                ...
                var l,
                  ...
                  h = Math.ceil(t.pageCount / s),
                  c = Math.floor(i / 2);
                r !== e.oldBasePageNumber &&
                  ((e.pageNumberChanged = !0),
                  this.updatePendingStatusClass(!0),
                  e.zoomViewer.reset()),
                  e.sheetsIndexShift(u, r, i);
                var p = Math.ceil(r / s);
                for (l = 0; l < i; l++) {
                  var d = void 0,
                    f = p - c + l;
                  if ((o && (f = h - f - 1), null != (d = e.sheets[l]))) {
                    ...
                    var g = d.side !== d.targetSide,
                      v = f !== d.pageNumber,
                      m = g && !1 === d.skipFlip && 1 === t.zoomValue;
                    if (
                      (!g &&
                        v &&
                        d.isFlipping &&
                ...
                if (
                  (o && "-1" === o.textureStamp
                    ? ((o.textureStamp = n.textureStamp),
                      ...
                      v.log("Texture Exchanging at " + i))
                    : v.log("Texture Exchanging Bypassed at " + i),
                  !this.isBooklet)
                ) {
                  ...
                  r && "-1" === r.textureStamp
                    ? ((r.textureStamp = a.textureStamp),
                      ...
                      v.log("Texture Exchanging at " + (i + 1)))
                    : v.log("Texture Exchanging Bypassed at " + (i + 1));
                }
                t.pagesReady();
              },
            },
            ...
            },
            {
              ...
              value: function () {
                var e = this,
                  ...
                  a = (e.fullWidth = 2 * o),
                  r = t.stage.innerWidth,
                  s = t.stage.innerHeight,
                  l = (e.shiftHeight = Math.ceil(v.limitAt((n - s) / 2, 0, n))),
                  u = (e.shiftWidth = Math.ceil(v.limitAt((a - r) / 2, 0, a)));
            ...
            },
            {
              ...
              value: function () {
                if (
                  ...
                  if (n) {
                    var a = v.contain(n.width, n.height, e, t);
                  ...
                  if (
                    ...
                    var r = v.contain(o.width, o.height, e, t);
                    (this.rightSheetWidth = Math.floor(r.width)),
                      (this.rightSheetHeight = Math.floor(r.height));
                  }
          ...
          p(e, [
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                var r = (0, d.removeNullCharacters)(t);
                a
                  ? (e.href = e.title = r)
                  : ((e.href = ""),
                    (e.title = "Disabled: ".concat(r)),
                    (e.onclick = function () {
                      return !1;
                    }));
                var s = "";
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  ...
                  console.log("i.pdfLoadProgress", pdfjsLib.getDocument({
                      ...
                      .then(function (n) {
                        ...
                        (i.pdfDocument = n),
                          n.getPage(1).then(function (o) {
                            var a;
                            i.coverPage = o;
                            var r = (i.coverPage.viewPort = o.getViewport({
                                scale: 1,
                                rotation:
                                  o._pageInfo.rotate + e.options.pageRotation,
                              })),
                              s = (i.coverPage.pageRatio = r.width / r.height),
                              l = s > 1;
                            (i.viewPorts[1] = r),
                        ...
                        if (null !== e && null != e.options) {
                          ...
                          var r =
                            (null === (n = e.options) || void 0 === n
                              ...
                              : n.fileName) || a.href;
                          e.updateInfo(
                            o + `<strong>Error: </strong>${e.options.source}  `
                            //   unescape(r) +
                            //   "<br><br>" +
                            //   t.message,
                            // "df-error"
                          ...
                          .promise.then(function () {
                            if (
                              ...
                              var s =
                                ...
                                "]";
                              d.log(
                                "CleanUp Requesting for (" + n + ") actual " + a
                              ),
          ...
          h(i, [
            {
              ...
              value: function () {
                ...
                (e.element = new S.Paper({
                  ...
                  (e.element.sheet = e),
                  (e.frontPage = new P({ sheet: e, face: 5 })),
                  (e.backPage = new P({ sheet: e, face: 4 })),
                  e.reset(),
                  e.updateAngle();
              },
            },
              ...
              value: function () {
                ...
                if (void 0 !== this.viewer && null !== this.viewer) {
                  ...
                  var v = (e.sheetAngle * Math.PI) / 180,
                    m = !0 === e.isHard ? v : (e.curveAngle * Math.PI) / 180,
                  ...
                  for (var P = 0; P < 1; P++) {
                    ...
                    (s[P] = new THREE.CubicBezierCurve3(
                      ...
                      (u[P] = s[P].getPoints(C)),
                      C > 2 && u[P].push(new THREE.Vector3().copy(u[P][C]));
                    for (
                      var E = void 0, x = u[P][0], T = 1;
                      T < u[P].length;
                      T++
                    )
                      (f += (E = u[P][T]).distanceTo(x)), g.push(f), (x = E);
                    (l[P] = new THREE.CubicBezierCurve3(
                      ...
                      (h[P] = l[P].getPoints(C)),
                      C > 2 && h[P].push(new THREE.Vector3().copy(h[P][C]));
                  }
                  var k = e.element.geometry;
                  if (void 0 !== k.attributes) {
                    var O = k.attributes.position,
                      R = k.attributes.uv,
                      L = n + 1;
                    O.setZ(0, u[0][n].z),
                      O.setZ(2, u[0][n].z),
                    ...
                    for (var N = 0; N < 1; N++)
                      for (var I = 0; I < L; I++)
                        O.setZ(8 + 0 * L + I, u[0][I].z),
                          O.setX(8 + 0 * L + I, u[0][I].x),
                          O.setZ(8 + 1 * L + I, h[0][I].z),
                          O.setX(8 + 1 * L + I, h[0][I].x),
                          O.setZ(8 + 2 * L + I, u[0][I].z),
                          O.setX(8 + 2 * L + I, u[0][I].x),
                          O.setZ(8 + 3 * L + I, h[0][I].z),
                          O.setX(8 + 3 * L + I, h[0][I].x),
                          O.setZ(8 + 4 * L + I, u[0][I].z),
                          O.setX(8 + 4 * L + I, u[0][I].x),
                          O.setZ(8 + 5 * L + I, u[0][I].z),
                          O.setX(8 + 5 * L + I, u[0][I].x),
                          R.setX(8 + 4 * L + I, g[I] / f),
                          R.setX(8 + 5 * L + I, g[I] / f),
                          O.setZ(8 + 6 * L + I, h[0][n - I].z),
                          O.setX(8 + 6 * L + I, h[0][n - I].x),
                          O.setZ(8 + 7 * L + I, h[0][n - I].z),
                          O.setX(8 + 7 * L + I, h[0][n - I].x),
                          R.setX(8 + 6 * L + I, 1 - g[n - I] / f),
                          R.setX(8 + 7 * L + I, 1 - g[n - I] / f);
                    ...
                    for (var F = 0; F < 1; F++)
                      for (var D = 1; D < n; D++)
                        (A[M].z = A[M + 3 * _].z = h[0][D].z),
                          (A[M].x = A[M + 3 * _].x = h[0][D].x),
                          (A[M + _].z = A[M + 2 * _].z = u[0][D].z),
                          (A[M + _].x = A[M + 2 * _].x = u[0][D].x),
                          M++;
                    for (
                      var z = k.faceVertexUvs[0], B = k.faces, j = 0, U = 0;
                      U < z.length;
                      U++
                    )
                      if (B[U].materialIndex === S.MATERIAL_FACE.BACK) {
                        var V = g[j] / f;
                        U % 2 == 0
                          ? ((z[U][0].x = z[U][1].x = z[U + 1][0].x = V), j++)
                          : (z[U - 1][2].x = z[U][1].x = z[U][2].x = V);
                      } else if (B[U].materialIndex === S.MATERIAL_FACE.FRONT) {
                        var H = 1 - g[j] / f;
                        U % 2 == 0
                          ? ((z[U][0].x = z[U][1].x = z[U + 1][0].x = H), j--)
                          : (z[U - 1][2].x = z[U][1].x = z[U][2].x = H);
                      }
                    k.computeBoundingBox(),
                      (e.element.scale.x = (1 * r) / f),
                      k.computeBoundingSphere(),
      ...
      w = (function (e) {
        ...
        function o(e, i) {
          ...
          return (
            ...
            ((s = t.call(this, e, i)).flexibility = y.limitAt(
            ...
            (s.color3DSheets =
              null !== (r = s.app.options.color3DSheets) && void 0 !== r
                ? r
                : "white"),
            s.initMOCKUP(function () {
              i._viewerPrepared();
            }),
            s
          );
        ...
        return (
          h(o, [
                  ...
                  ? (t.updateInfo(t.options.text.loading + " WEBGL 3D ..."),
                    "function" == typeof define && i(6) && window.requirejs
                      ...
                      ? window.require(
                          ...
                          function (t) {
                            t(function () {
                              S.init(), "function" == typeof e && e();
                            });
                          }
                        )
                      : y.getScript(
                          t.options.threejsSrc + "?ver=" + m.version,
                          function () {
                            S.init(), "function" == typeof e && e();
                          },
                          function () {
            ...
            },
            {
              ...
              value: function () {
                var e = this.app;
                r(v(o.prototype), "init", this).call(this);
            ...
            },
            {
              key: "updatePageMode",
              value: function () {
                r(v(o.prototype), "updatePageMode", this).call(this);
                var e = this.app;
                (this.has3DCover =
            ...
            },
            {
              ...
              value: function () {
                ...
                jQuery(n.domElement)
                  ...
                  (e.app.renderRequestStatus = m.REQUEST_STATUS.ON);
              },
            },
            {
              key: "initPages",
            ...
            },
            {
              ...
              value: function () {
                (this.stageDOM = this.element[0]),
                  r(v(o.prototype), "initEvents", this).call(this);
              },
            },
            {
              key: "dispose",
              value: function () {
                r(v(o.prototype), "dispose", this).call(this);
                var e = this;
                e.stage &&
                  (e.stage.clearChild(),
            ...
            },
            {
              key: "resize",
              value: function () {
                r(v(o.prototype), "resize", this).call(this);
                var e = this,
                  t = e.app,
                  i = e.stage,
                  n = t.dimensions,
                ...
                i.camera.position.z !== s &&
                  !0 === t.pendingZoom &&
                  (i.camera.position.z = s),
                  1 === t.zoomValue &&
                    (i.camera.position.set(u, l, s),
            ...
            { key: "updateShadowSize", value: function () {} },
            {
              ...
              value: function () {
                var e = this,
                  ...
                  h =
                    (Math.max(a, s), this.isBooklet ? 0 : this.flexibility / u);
                (e.leftFlexibility = h * s),
                  (e.rightFlexibility = h * a),
                  (e.midPosition = 0.5 * l * e.sheetDepth),
                  r(v(o.prototype), "refresh", this).call(this);
                ...
                if (
                  ...
                  var b = this.isClosedPage() && ((f && m) || (!f && g)),
                    w = this.isClosedPage() && ((!f && m) || (f && g));
            ...
            },
            {
              ...
              value: function (e) {
                ...
                (o.leftFlexibility = s ? i.leftFlexibility : 0),
                  (o.rightFlexibility = s ? i.rightFlexibility : 0),
                  (o.leftPos =
                    i.midPosition +
                  ...
                  !1 === o.isFlipping &&
                    ...
                    o.updateAngle(),
                    (this.app.renderRequestStatus = m.REQUEST_STATUS.ON)),
              ...
              value: function () {
                ...
                (e.seamPosition =
                  ...
                  n !== e.centerEnd &&
                    ...
                    (e.centerEnd = n)),
                  (e.renderRequestStatus = m.REQUEST_STATUS.ON),
            ...
            },
            {
              ...
              value: function () {
                var e,
                  ...
                  r = this.isRTL && t.isBooklet ? void 0 : t.getPageByNumber(o);
                if (
                ...
                if (
                  ...
                  if (null !== t.dragSheet && !1 !== t.drag3D) {
                    var n =
                        ...
                        Math.PI,
                      o = t.dragSheet,
                      a = t.drag === m.TURN_DIRECTION.LEFT;
                    o.sheetAngle = n;
                    var r = a
                ...
                if ((e = y.fixMouseEvent(e)).touches || 0 === e.button)
                  if (null == e.touches || 0 != e.touches.length) {
                    ...
                    if (1 === t.app.zoomValue) {
                      null !== t.dragSheet &&
                        (i.x > t.app.dimensions.width / 2
                          ? t.drag === m.TURN_DIRECTION.LEFT && t.app.openLeft()
                          : t.drag === m.TURN_DIRECTION.RIGHT &&
                            t.app.openRight(),
                        t.requestRefresh());
                    ...
                    (t.dragSheet = null),
                      ...
                      (t.startPoint = null),
                      (t.canSwipe = !1),
                      (t.app.renderRequestStatus = m.REQUEST_STATUS.ON);
                  } else this.pinchUp(e);
              },
            },
            {
            ...
            },
            {
              key: "getTextureSize",
              value: function (e) {
                var t = r(v(o.prototype), "getTextureSize", this).call(this, e);
            ...
            },
            {
              ...
              value: function (e) {
                ...
                return r(v(o.prototype), "getPageByNumber", this).call(this, e);
              },
            },
            {
              key: "setPage",
              value: function (e) {
                return r(v(o.prototype), "setPage", this).call(this, e);
              },
            },
            {
              key: "beforeFlip",
              value: function () {
                r(v(o.prototype), "beforeFlip", this).call(this);
              },
            },
            {
              ...
              value: function (e) {
                ...
                if (!t || "" === t.style.width) {
                  var i = this.getPageByNumber(e),
                    n = r(v(o.prototype), "getViewPort", this).call(this, e);
                  if (i && n) {
                    ...
                    if (s.lastStamp != a) {
                      var l = i.sheet.element.geometry.boundingBox,
                        ...
                        p = s.element.querySelectorAll("section");
                      p.length > 0 &&
            ...
            },
            {
              key: "finalizeAnnotations",
              value: function (e, t) {
                r(v(o.prototype), "finalizeAnnotations", this).call(this, e, t),
          ...
          if (!0 !== S.initialized) {
            ...
            (S = {
                ...
                return (
                  "CANVAS" === i.nodeName || "IMG" === i.nodeName
                    ? (((s = new e.Texture(i)).needsUpdate = !0),
                      S.loadTexture(s, t, o, n),
                      "function" == typeof a && a(t, s))
                    : "blank" !== i
                    ? (s =
                        null == i
                          ? null
                          : S.textureLoader.load(
                              i,
                              function (e) {
                                (e.sourceFile = i),
                                  S.loadTexture(e, t, o, n),
                              ...
                              function () {
                                null == s.image &&
                                  S.loadImage(
                                    t,
                                    S.defaults.textureLoadFallback,
                                    n,
                                    o
                                  ),
                                  S.loadTextureFailed();
              ...
              loadTexture: function (t, i, n, o) {
                ...
                null !== t &&
                  "map" === n &&
                  ((t.anisotropy = 0),
                  S.defaults.anisotropy > 0 &&
                    (t.anisotropy = S.defaults.anisotropy),
                  !0 === e.skipPowerOfTwo &&
                    ((t.minFilter = e.LinearFilter),
                    (t.magFilter = e.LinearFilter)),
                  (t.name = new Date().toTimeString())),
                  S.clearTexture(i.material[o][n]),
                  (i.material[o][n] = t),
                  "bumpMap" === n &&
            ...
            var t = (function (t) {
                ...
                function n(t) {
                  var o;
                  l(this, n);
                  var a = t.width || S.defaults.width,
                    r = t.height || S.defaults.height,
                    s = t.color || S.defaults.color,
                    u = t.segments || S.defaults.segments,
                    h = t.depth || S.defaults.depth,
                    c = {
                      color: s,
                      flatShading: !1,
                      shininess: t.shininess || S.defaults.shininess,
                    },
                  ...
                  h(n, [
                    {
                      key: "frontImage",
                      value: function (e, t) {
                        S.loadImage(this, e, S.MATERIAL_FACE.FRONT, "map", t);
                      },
                    },
                    {
                      key: "backImage",
                      value: function (e, t) {
                        S.loadImage(this, e, S.MATERIAL_FACE.BACK, "map", t);
                      },
                    },
                    {
                      key: "loadBump",
              ...
              i = (function (e) {
                ...
                function i(e) {
                  ...
                  return (
                    ...
                    n.frontImage(S.defaults.groundTexture),
                    n.backImage(S.defaults.groundTexture),
                    (n.type = "Ground"),
                    n
                  );
                }
              ...
              n = (function (t) {
                ...
                function o(t) {
                  ...
                  (r.canvas = t.canvas || document.createElement("canvas")),
                    ...
                    ((r.orbitControl = new e.OrbitControls(
                      r.camera,
                      r.renderer.domElement
                  ...
                  var s = (r.spotLight = new e.DirectionalLight(
                    16777215,
                    0.25
                  ));
                  return (
                    ...
                    r.orbitControl.center.set(0, 0, 0),
                        ...
                        for (var e = this.children.length - 1; e >= 0; e--) {
                          ...
                          if (t.children && t.children.length > 0)
                            for (var i = t.children.length - 1; i >= 0; i--)
                              S.clearChild(t.children[i]);
                          S.clearChild(t), (t = null);
                        }
                        this.render();
                      },
                    },
            ...
            (S.Paper = t),
              ...
              (e.OrbitControls = function (t, i) {
                ...
                var I = new e.Quaternion().setFromUnitVectors(
                    t.up,
                    new e.Vector3(0, 1, 0)
                  ),
                  A =
                    "function" == typeof I.inverse
                      ? I.clone().inverse()
                      : I.clone().invert(),
                  _ = { type: "change" },
                  M = { type: "start" },
                ...
                function B(e) {
                  if (!1 !== a.enabled) {
                    if (
                      ...
                      (N = x), s.set(e.clientX, e.clientY);
                    } else if (e.button === a.mouseButtons.ZOOM) {
                      if (!0 === a.noZoom) return;
                      (N = T), g.set(e.clientX, e.clientY);
                  ...
                  if (!1 !== a.enabled) {
                    ...
                    if (N === x) {
                      ...
                      l.set(e.clientX, e.clientY),
                        ...
                        a.rotateUp(
                          ((2 * Math.PI * u.y) / t.clientHeight) * a.rotateSpeed
                        ),
                        s.copy(l);
                    } else if (N === T) {
                      if (!0 === a.noZoom) return;
                      v.set(e.clientX, e.clientY),
                        m.subVectors(v, g),
                        m.y > 0 ? a.dollyIn() : m.y < 0 && a.dollyOut(),
                        g.copy(v);
                    } else if (N === k) {
                      if (!0 === a.noPan) return;
                ...
                function W(t) {
                  if (!1 !== a.enabled) {
                    ...
                    switch (
                      ...
                      case 4:
                        if (!0 === a.noRotate) return;
                        (N = O), s.set(t.touches[0].pageX, t.touches[0].pageY);
                        break;
                      case 2:
                        if (!0 === a.noZoom) return;
                        N = R;
                  ...
                  if (!1 !== a.enabled) {
                    ...
                    switch (
                      ...
                      case 2:
                        ...
                        v.set(0, d),
                          m.subVectors(v, g),
                          m.y > 0 ? a.dollyOut() : m.y < 0 && a.dollyIn(),
                          g.copy(v),
                          a.update();
                        break;
                      case 3:
                ...
                function Q() {
                  !1 !== a.enabled && (a.dispatchEvent(F), (N = E));
                }
                function G(e) {
                  e.preventDefault();
                }
                (this.rotateLeft = function (e) {
                  ...
                  (this.panLeft = function (e) {
                    ...
                    d.set(t[0], t[1], t[2]), d.multiplyScalar(-e), P.add(d);
                  }),
                  (this.panUp = function (e) {
                    var t = this.object.matrix.elements;
                    d.set(t[4], t[5], t[6]), d.multiplyScalar(e), P.add(d);
                  }),
                  ...
                  (this.update = function () {
                    ...
                    f.copy(e).sub(this.target),
                      ...
                      this.autoRotate && N === E && this.rotateLeft(D()),
                      (n += b),
                      (o += y),
                      (n = Math.max(
                    ...
                    (t = Math.max(
                      ...
                      (w = 1),
                      P.set(0, 0, 0),
                      (S.distanceToSquared(this.object.position) > r ||
                        8 * (1 - C.dot(this.object.quaternion)) > r) &&
                        (this.dispatchEvent(_),
                        S.copy(this.object.position),
  ...
  function (e, t, i) {
    ...
    var l = n.a.utils,
              ...
              value: function () {
                ...
                e.createLogo(),
                  (this.openRight = a.openRight =
                    jQuery(t, {
                      ...
                      title: i.isRTL ? r.previousPage : r.nextPage,
                  ...
                  (this.openLeft = a.openLeft =
                    jQuery(t, {
                      ...
                      title: i.isRTL ? r.nextPage : r.previousPage,
                ...
                (this.pageInput = a.pageInput =
                  ...
                  (this.thumbnail = a.thumbnail =
                    l.createBtn("thumbnail", s.thumbnail, r.toggleThumbnails)),
                  a.thumbnail
                    .on("click", function () {
                      var t = jQuery(this);
                  ...
                  i.hasOutline() &&
                    ((this.outline = a.outline =
                      l.createBtn("outline", s.outline, r.toggleOutline)),
                    a.outline
                      .on("click", function () {
                        var t = jQuery(this);
                        if (
                ...
                if (
                  ((this.zoomIn = a.zoomIn =
                    l
                      .createBtn("zoomin", s.zoomin, r.zoomIn)
                      .on("click", function () {
                        i.zoom(1), e.update();
                      })),
                  (this.zoomOut = a.zoomOut =
                    l
                      .createBtn("zoomout", s.zoomout, r.zoomOut)
                      .on("click", function () {
                        i.zoom(-1), e.update();
                      })),
                  (this.resetZoom = a.resetZoom =
                    l
                      .createBtn("resetzoom", s.resetzoom, r.resetZoom)
                      .on("click", function () {
                  ...
                  this.pageMode = a.pageMode = l
                    .createBtn(
                      "pagemode",
                      s[d ? "doublepage" : "singlepage"],
                      d ? r.doublePageMode : r.singlePageMode
                    )
                    .on("click", function () {
                      var e = jQuery(this);
                      i.viewer.setPageMode({
                        ...
                        i.viewer.pageMode === n.a.FLIPBOOK_PAGE_MODE.DOUBLE
                          ? a.pageMode
                              .removeClass(s.doublepage)
                              .addClass(s.singlepage)
                              .attr("title", r.singlePageMode)
                              .html("<span>" + r.singlePageMode + "</span>")
                          : a.pageMode
                              .addClass(s.doublepage)
                              .removeClass(s.singlepage)
                              .attr("title", r.doublePageMode)
                              .html("<span>" + r.doublePageMode + "</span>");
                    });
                } else
                  this.pageFit = a.pageFit = l
                    .createBtn("pagefit", s.pagefit, r.pageFit)
                    .on("click", function () {
                      var e = a.pageFit;
                      !0 === !e.hasClass(s.widthfit)
                        ? (e.addClass(s.widthfit),
                          e.html("<span>" + r.widthFit + "</span>"),
                          e.attr("title", r.widthFit))
                        : (e.removeClass(s.widthfit),
                          e.html("<span>" + r.pageFit + "</span>"),
                          e.attr("title", r.pageFit));
                    });
                if (
                  ((e.shareBox = new c(i.container, i.options)),
                  (this.share = a.share =
                    l
                      .createBtn("share", s.share, r.share)
                      .on("click", function () {
                        !0 === e.shareBox.isOpen
                          ? e.shareBox.close()
                  ...
                  (this.more = a.more =
                    l.createBtn("more", s.more).on("click", function (t) {
                  ...
                  (this.startPage = a.startPage =
                    l
                      .createBtn("start", s.start, r.gotoFirstPage)
                      .on("click", function () {
                        i.start();
                      })),
                  (this.endPage = a.endPage =
                    l
                      .createBtn("end", s.end, r.gotoLastPage)
                      .on("click", function () {
                        i.end();
                      })),
                  (this.print = a.print =
                    l
                      .createBtn("print", s.print, r.print)
                      .on("click", function () {
                        i.print();
                      })),
                  !0 === i.options.showDownloadControl)
                ) {
                  var f = "df-ui-btn df-ui-download " + s.download;
                ...
                var g = i.options.allControls.replace(/ /g, "").split(","),
                  v = "," + i.options.moreControls.replace(/ /g, "") + ",",
                  m = "," + i.options.hideControls.replace(/ /g, "") + ",";
                m += ",";
            ...
            },
            {
              ...
              value: function () {
                ...
                var i = e.isRTL,
                  ...
                  a = (n && !i) || (o && i),
                  r = (o && !i) || (n && i);
                t.openRight.toggleClass("df-hidden", r),
      ...
      g = (function () {
        function e(t) {
          ...
          for (var r = this, s = 0; s < this.totalRows; s++) {
            var l = document.createElement("div"),
              h = s + 1;
            l.id = "df-thumb" + h;
          ...
          (r.dispose = function () {
            r.container &&
              ...
              r.container.removeEventListener("scroll", f);
          }),
            r.container.addEventListener("scroll", f);
        }
        return (
          s(e, [
            {
              ...
              value: function () {
                ...
                if (
                  ...
                  var r = l.getVisibleElements({
                    container: e.thumblist.container,
                    elements: e.thumblist.container.children,
                  });
                  jQuery.inArray(r) && r.unshift(e.activeThumb);
                  for (var s = 0; s < r.length; s++) {
                    var h = e.thumblist.container.children[r[s] - 1];
                    if (
                      void 0 !== h &&
    ...
    (n.a.openLightBox = function (e) {
      n.a.activeLightBox ||
        (n.a.activeLightBox = new p(function () {
          n.a.activeLightBox.app &&
            ((n.a.activeLightBox.app.closeRequested = !0),
        ...
        (void 0 !== n.a.activeLightBox.app &&
          null !== n.a.activeLightBox.app &&
          !0 !== n.a.activeLightBox.app.closeRequested &&
          n.a.openLocalFileElement != e) ||
          ((n.a.activeLightBox.app = l.disposeObject(n.a.activeLightBox.app)),
          null === n.a.activeLightBox.app &&
      ...
      b = (function () {
        function e(t) {
          ...
          !(function (e, t) {
            ...
            (this.jumpStep = 1),
            (this.resizeRequestStatus = m.OFF),
            (this.refreshRequestStatus = m.OFF),
        ...
        return (
          ...
          (i = [
            ...
            },
            {
              ...
              value: function () {
                (this.resizeRequestStatus = m.COUNT),
                  (this.resizeRequestCount = 0),
                ...
                e.checkRequestQueue &&
                  ...
                  e.container &&
                    ...
                    null !== e._offsetParent &&
                      (e.resize(), (e.resizeRequestStatus = m.OFF)),
                    y.log("Visibility Resize Detected")),
                  (null !== e._offsetParent || e.isFullscreen) &&
                    (TWEEN.getAll().length > 0 &&
                      (TWEEN.update(), (e.renderRequestStatus = m.ON)),
                    e.resizeRequestStatus === m.ON
                      ? ((e.resizeRequestStatus = m.OFF), e.resize())
                      : e.resizeRequestStatus === m.COUNT &&
                        (e.resizeRequestCount++,
                        e.resizeRequestCount > 10 &&
                          ((e.resizeRequestCount = 0),
                          (e.resizeRequestStatus = m.ON))),
                    e.refreshRequestStatus === m.ON
                      ? ((e.refreshRequestStatus = m.OFF),
                        (e.pendingResize = !1),
                        e.viewer.refresh(),
                        this.container.removeClass("df-pendingresize"))
                      : e.refreshRequestStatus === m.COUNT &&
                        (e.refreshRequestCount++,
                        e.refreshRequestCount > 3 &&
                          ((e.refreshRequestCount = 0),
                          (e.refreshRequestStatus = m.ON))),
                    e.textureRequestStatus === m.ON &&
                      e.processTextureRequest(),
                    e.thumbRequestStatus === m.ON
                      ? e.processThumbRequest()
                      : e.thumbRequestStatus === m.COUNT &&
                        (e.thumbRequestCount++,
                        e.thumbRequestCount > 3 &&
                          ((e.thumbRequestCount = 0),
                          (e.thumbRequestStatus = m.ON))),
                    e.renderRequestStatus === m.ON &&
                      (e.viewer.render(), (e.renderRequestStatus = m.OFF)),
            ...
            },
            {
              ...
              value: function () {
                var e,
                  ...
                  s = 0,
                  l = i.zoomValue > 1;
                if (o.isAnimating()) i.textureRequestStatus = m.ON;
                else {
                  ...
                  0 === s && (i.textureRequestStatus = m.OFF);
                }
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                (this.refreshRequestStatus = m.COUNT),
                  (this.refreshRequestCount = 0);
              },
            },
            {
              ...
              value: function () {
                this.renderRequestStatus = m.ON;
              },
            },
            {
              key: "resizeRequestStart",
              value: function () {
                this.resizeRequestStatus = m.ON;
              },
            },
            {
              key: "zoom",
              ...
              value: function () {
                ...
                (r.offset = {
                  ...
                  o.viewerContainer.css({
                    left: r.offset.left,
                    right: r.offset.right,
                  });
                var u = (r.controlsHeight = o.container
                  .find(".df-ui")
                  .height());
                if (
                  ((s.top =
                    ...
                    (o.options.controlsPosition === n.a.CONTROLS_POSITION.TOP
                      ? u
                      : 0)),
                  (s.left = o.options.paddingLeft),
                  (s.right = o.options.paddingRight),
                  (s.bottom =
                  ...
                  (s.heightDiff = s.top - s.bottom),
                  (s.widthDiff = s.left - s.right),
                  (r.isFullSize = !0 === o.isFullscreen),
                  (r.isFixedHeight = r.isFullSize || !r.isAutoHeight),
                  (r.containerWidth = r.isFullSize
                    ? jQuery(window).width()
                    : this.element.width()),
                  o.container
                    .toggleClass("df-xs", r.containerWidth < 400)
                    .toggleClass("df-xss", r.containerWidth < 320),
                  (r.maxHeight =
                    l -
                    (r.containerWidth > 600 &&
                    null !==
                      (e = jQuery(
                  ...
                  if (r.isFullSize) r.maxHeight = l;
                  else {
                    o.element.height(o.options.height);
                    var h = o.element.height();
                    r.maxHeight = Math.min(h, r.maxHeight);
                  }
                r.width, (r.stage.innerWidth = this.viewer._getInnerWidth());
                var c = (r.stage.innerHeight = this.viewer._getInnerHeight()),
                  p = this.viewer._getOuterHeight(c + r.padding.height);
                (r.containerHeight = r.isFullSize ? l : p),
                  o.element.height(r.containerHeight);
                var d = o.element.height();
                r.isFullSize ||
                  d == r.containerHeight ||
                  ((r.containerHeight = d),
                  (r.stage.innerHeight = d - r.padding.height),
                  (r.stage.height = d)),
                  (r.origin = {
                    x:
                      (s.widthDiff +
                        ...
                        r.offset.right) /
                      2,
                    y: (s.heightDiff + r.containerHeight) / 2,
                  }),
                  o.viewer.handleZoom(),
                  o.viewer.resize(),
                  !1 !== i &&
                    (o.pendingZoom
                      ? (this.viewer.refresh(), y.log("Pending Zoom updated"))
                ...
                if (
                  ...
                  n.requestFullscreen
                    ...
                    o &&
                      o.then &&
                      o.then(function () {
                        i.refreshRequestStatus, m.ON, i.resize();
                      }),
                    (i.isFullscreen = !0);
                } else
                  (i.isFullscreen = !1),
                    document.exitFullscreen
                      ...
                      : document.webkitExitFullscreen &&
                        document.webkitExitFullscreen(),
                    y.hasFullscreenEnabled() || i.container[0].scrollIntoView();
                y.hasFullscreenEnabled() || (i.resizeRequestStatus = m.ON);
              },
            },
            {
              key: "next",
    ...
    (n.a.prepareOptions = function (e) {
      ...
      var r = jQuery.extend(!0, {}, n.a._defaults, a);
      return (
        y.isMobile &&
          "function" == typeof n.a.viewers[r.mobileViewerType] &&
          (r.viewerType = r.mobileViewerType),
        "function" != typeof n.a.viewers[r.viewerType]
          ? (console.warn(
              "Invalid Viewer Type! " +
                r.viewerType +
                " | Using default Viewer!"
            ),
            (r.viewerType = n.a.viewers.default))
          : (r.viewerType = n.a.viewers[r.viewerType]),
        (r = y.finalizeOptions(y.sanitizeOptions(r)))
      );
    }),
      ...
      g = (function (e) {
        ...
        function c(e, t) {
          ...
          return (
            ...
            ((i = r.call(this, e, t)).app.jumpStep = 1),
            (i.minZoom = 0.25),
              ...
              value: function () {
                ...
                if (
                  ...
                  var d =
                      o.offsetTop +
                      o.clientTop -
                      (a.top - r.top + o.clientTop) * p,
                    f =
                      o.offsetLeft +
                      o.clientLeft -
                      (a.left - r.left + o.clientLeft) * p;
                  (d += (10 * (p - 1)) / 2),
                    (f += (10 * (p - 1)) / 2),
                    (this.zoomCenter =
            ...
            },
            {
              ...
              value: function (e) {
                for (
                  ...
                  a = o[r];
                  var s = t.pages[a - 1].element[0],
                    l = s.offsetTop + s.clientTop;
                  if (l <= i && s.clientHeight + l >= i) break;
                  if (r > 0 && l > i && s.clientHeight + l >= i) {
                    a = o[r - 1];
                    break;
                  }
                }
          ...
          h(i, [
            {
              ...
              value: function () {
                ...
                var r = (e.wrapper = jQuery(t, { class: "df-sheet-wrapper" })),
                  s = (e.foldInnerShadow = jQuery(t, {
              ...
              value: function (e, t, i) {
                (e = Math.floor(e)),
                  ...
                  (this.wrapper[0].style.height = this.wrapper[0].style.width =
                    Math.ceil(m.distOrigin(e, t) * this.viewer.app.zoomValue) +
                    "px"),
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (
                  ...
                  var i,
                    ...
                    l =
                      ...
                      t.viewer.corner === n.a.TURN_CORNER.BR
                        ? t.element.height()
                        : 0,
                    u = t.viewer.leftSheetWidth + t.viewer.rightSheetWidth,
                    h = 0;
                  (o = t.end =
                  ...
                  !0 === t.isHard
                    ? (null != e &&
                        (h = m.angleByDistance(e.distance, e.fullWidth)),
                      (i = t.init = { angle: h * (r ? -1 : 1) }),
                      (o = t.end =
                        t && !0 === t.animateToReset
                          ? { angle: r ? 0 : -0 }
                          : { angle: r ? -180 : 180 }))
              ...
              value: function (e) {
                ...
                if (null != e) {
                  var i = t.element.width(),
                    ...
                    l = a === r.BL || a === r.BR;
                  (e.rx = !0 === s ? t.viewer.leftSheetWidth + i - e.x : e.x),
                    (e.ry = !0 === l ? o - e.y : e.y);
                  var u = Math.atan2(e.ry, e.rx);
                  u = Math.PI / 2 - m.limitAt(u, 0, m.toRad(90));
                  var h = i - e.rx / 2,
                    c = e.ry / 2,
                    p = Math.max(
                      0,
                      Math.sin(u - Math.atan2(c, h)) * m.distOrigin(h, c)
                    ),
                    d = 0.5 * m.distOrigin(e.rx, e.ry),
                    f = Math.ceil(i - p * Math.sin(u)),
                    g = Math.ceil(p * Math.cos(u)),
                    v = m.toDeg(u),
                    y = l ? (s ? 90 - v + 180 : 180 + v) : s ? v : 90 - v,
                    b = l ? (s ? 90 - v + 180 : v) : s ? v + 180 : y,
                    w = l ? (s ? 90 - v : v + 90) : s ? y - 90 : y + 180,
                    P = s ? i - f : f,
                    S = l ? o + g : -g,
                    C = s ? -f : f - i,
                    E = l ? -o - g : g,
                    x = m.limitAt((0.5 * e.distance) / i, 0, 0.5),
                    T = m.limitAt(
                      (0.5 * (t.viewer.leftSheetWidth + i - e.rx)) / i,
                      0.05,
                      0.3
                    );
                  t.element.addClass("df-folding");
                  var k = s ? t.backPage.element : t.frontPage.element,
                    O = s ? t.frontPage.element : t.backPage.element,
                    R = t.foldOuterShadow,
                    L = t.foldInnerShadow;
                  t.wrapper.css({
                    transform: m.translateStr(P, S) + m.rotateStr(y),
                  }),
                    O.css({
                      transform: m.rotateStr(-y) + m.translateStr(-P, -S),
                    }),
                    k.css({
                      transform: m.rotateStr(b) + m.translateStr(C, E),
          ...
          h(i, [
            {
              key: "init",
              value: function () {
                r(g(i.prototype), "init", this).call(this),
                  this.initEvents(),
                  this.initPages();
              },
            },
            {
              ...
              value: function () {
                (this.stageDOM = this.element[0]),
                  r(g(i.prototype), "initEvents", this).call(this);
              },
            },
            {
              key: "dispose",
              value: function () {
                r(g(i.prototype), "dispose", this).call(this),
                  this.element.remove();
              },
            },
            {
            ...
            },
            {
              key: "resize",
              value: function () {
                r(g(i.prototype), "resize", this).call(this);
                var e = this,
                  t = e.app.dimensions,
                  n = t.padding,
                  ...
                  h = (e.shiftHeight = Math.ceil(
                    m.limitAt((o - u + n.height) / 2, 0, o)
                  )),
                  c = (e.shiftWidth = Math.ceil(
                    m.limitAt((s - l + n.width) / 2, 0, s)
                  ));
                1 === e.app.zoomValue && ((e.left = 0), (e.top = 0)),
                  void 0 === this.rightSheetHeight &&
                    ((this.rightSheetHeight = this._containCover.height),
                ...
                !1 === t.isFlipping &&
                  (e.needsFlip
                    ...
                    : ((t.skipFlip = !1),
                      ...
                      t.element.addClass(
                        t.targetSide === v.TURN_DIRECTION.LEFT
                          ? "df-left-side"
                          : "df-right-side"
                      ),
                      (t.side = t.targetSide),
            ...
            },
            {
              ...
              value: function (e) {
                ...
                (f.x = f.x - g.left),
                  (f.y = f.y - g.top),
                  (i = (h = t.dragSheet
                    ? t.dragSheet.side === v.TURN_DIRECTION.RIGHT
                    : f.x > t.seamPosition)
                    ? t.rightSheetWidth
                    : t.leftSheetWidth),
                  ...
                  (r = f.y - (c.top - g.top) - r),
                  (s =
                    t.drag === v.TURN_DIRECTION.NONE
                      ? a < i
                        ? a
                        : n - a
                      : t.drag === v.TURN_DIRECTION.LEFT
                      ? a
                      : n - a),
                    ...
                    (y =
                      b >= 0 && b < C
                        ...
                        ? w >= 0 && w <= C
                          ...
                          ? v.TURN_CORNER.R
                          : v.TURN_CORNER.NONE
                        : v.TURN_CORNER.NONE) !== v.TURN_CORNER.NONE &&
                    y !== v.TURN_CORNER.L &&
                    y !== v.TURN_CORNER.R,
                  x: p ? f.x : a,
                  y: p ? f.y : r,
              ...
              value: function (e) {
                ...
                if (null == e.touches || 2 != e.touches.length) {
                  ...
                  if (
                    ...
                    null != t.dragSheet ||
                      ((i.y = m.limitAt(i.y, 1, t.availablePageHeight() - 1)),
                      (i.x = m.limitAt(i.x, 1, i.fullWidth - 1)));
                    var o = null != t.dragSheet ? t.corner : i.corner;
                    if (n.isHard) {
                      var a = o === v.TURN_CORNER.BR || o === v.TURN_CORNER.TR,
                        r = m.angleByDistance(i.distance, i.fullWidth);
              ...
              value: function (e) {
                if (e.touches || 0 === e.button)
                  if (null == e.touches || 0 != e.touches.length) {
                    var t = this,
                      i = t.eventToPoint(e),
                      o = e.target || e.originalTarget,
                      a =
                        1 === t.app.zoomValue &&
                        i.x === t.startPoint.x &&
                        i.y === t.startPoint.y &&
                        "A" !== o.nodeName;
                    if (!0 === e.ctrlKey && a) this.zoomOnPoint(i);
                    else if (t.dragSheet) {
                      e.preventDefault();
                      var r = t.dragSheet;
                      if (
                        ...
                        i.distance > i.sheetWidth &&
                          (i.sheet.side === n.a.TURN_DIRECTION.LEFT
                            ? t.app.openLeft()
                            : t.app.openRight()),
                          s === this.getBasePage() &&
                            ((r.animateToReset = !0), r.flip(i));
                      }
                      (t.dragSheet = null), (r.magnetic = !1);
                    } else
                      a &&
                        !i.sheet.isFlipping &&
                        i.isInsideSheet &&
        ...
        (this.to = function (e, t) {
          ...
          (this.update = function (e) {
            ...
            if ((null != y && y.call(t, w), 1 === u)) {
              ...
              null != b && b.call(t);
              for (var E = 0, x = g.length; E < x; E++) g[E].start(p + r);
              return !1;
            }
            return !0;
          });
  ...
  function (e, t, i) {
    ...
    var n = i(0),
      ...
      a = i(5),
      r = i(8);
    (r.a.prototype.executeCallback = function (e) {
      "function" == typeof this.options[e] && this.options[e](this);
    }),
      (r.a.prototype.analytics = function (e) {
      ...
      (n.a.executeCallback = function (e) {
        var t =
          arguments.length > 1 && void 0 !== arguments[1]
            ? arguments[1]
            : window;
      ...
      (n.a.openAttachmentLightBoxes = function () {
        var e = jQuery(
          "body.attachment-pdf [apl], body.attachment-pdf [attachment_pdf_lightbox]"
        );
        e.length > 0 && jQuery(e[0]).trigger("click"),
          jQuery(window).on("hashchange", function (e) {
            ...
            t &&
              t.length > 5 &&
              ((n.a.hashFocusBookFound = !1), o.a.detectHash());
          });
      }),
      (a.a.prototype.processCustomLinks = function (e, t) {
        var i = this,
          n = this.app;
        if (
      ...
      (a.b.prototype.processTextContent = function (e, t) {}),
      (a.b.prototype.processAnnotations = function (e, t) {
        var i = this,
          n = this.app;
        if (
          !1 !== n.options.enableAnnotation &&
          ...
          var o = n.viewer.getDocumentPageNumber(e);
          i.pdfDocument.getPage(o).then(function (o) {
            var a = o.getViewport({
              scale: 1,
              rotation: o._pageInfo.rotate + n.options.pageRotation,
            });
            (a = o.getViewport({
              scale:
              ...
              o.getAnnotations().then(function (r) {
                if (null !== n.options && null !== n.viewer) {
                  a = a.clone({ dontFlip: !0 });
                  var s = {
                    annotations: r,
                    div: t,
                    page: o,
                  ...
                  pdfjsLib.AnnotationLayer.render(s),
      ...
      (n.a.getPDFThumb = function (e) {
        var t = {};
        (t.url = o.a.httpsCorrection(e.pdfURL)),
          (t.rangeChunkSize = 524288),
          (t.cMapPacked = !0),
          (t.disableAutoFetch = !0),
          (t.disableStream = !0),
          (t.disableFontFace = n.a.defaults.disableFontFace),
          (t.cMapUrl = n.a.defaults.cMapUrl),
          (t.imagesLocation = n.a.defaults.imagesLocation),
          (t.imageResourcesPath = n.a.defaults.imageResourcesPath);
        var i = pdfjsLib.getDocument(t),
          a = i.promise.then(function (t) {
            t.getPage(1).then(function (t) {
              var n = 1,
                o = document.createElement("canvas"),
                r = t.getViewport({ scale: n });
              (n =
                r.width > r.height
                  ? (400 * n) / r.width
                  : (400 * n) / r.height),
                (r = t.getViewport({ scale: n })),
                (o.height = Math.floor(r.height)),
                (o.width = Math.floor(r.width)),
                t
                  .render({
                    canvas: o,
        ...
        i.onProgress = function (t) {
          ...
          isNaN(i)
            ...
            : e.updateInfo(
                "Loading PDF " + Math.ceil(i).toString().split(".")[0] + "% ..."
              );
        };
      });
  },
  function (e, t, i) {
    ...
    var S = n.a.utils;
    (o.a.prototype.pinchDown = function (e) {
      null != e.touches &&
        2 == e.touches.length &&
        null == this.startTouches &&
        ((this.startTouches = S.getTouches(e)),
        (this.app.viewer.zoomCenter = S.getVectorAvg(
          S.getTouches(e, this.parentElement.offset())
        )),
        (this.lastScale = 1));
    }),
      (o.a.prototype.pinchUp = function (e) {
        null != e.touches &&
          e.touches.length < 2 &&
          1 == this.pinchZoomDirty &&
      ...
      (o.a.prototype.pinchMove = function (e) {
        if (
          null != e.touches &&
          2 == e.touches.length &&
          null != this.startTouches
          ...
          var t = S.calculateScale(this.startTouches, S.getTouches(e));
          this.lastScale;
          return (
            (this.lastScale = t),
            (this.app.viewer.pinchZoomUpdateScale = S.limitAt(
              t,
            ...
            this.app.viewer._pinchZoomLastScale !=
              ...
              ((this.app.viewer.pinchZoomRequestStatus = n.a.REQUEST_STATUS.ON),
              (this.app.viewer._pinchZoomLastScale =
                this.app.viewer.pinchZoomUpdateScale)),
            void e.preventDefault()
          );
    ...
    var C = (function (e) {
      ...
      var t,
        ...
        o = b(a);
      function a(e, t) {
        return g(this, a), o.call(this, e, t);
      }
      return (
        (t = a),
        (i = [
          {
            key: "init",
            value: function () {
              m(P(a.prototype), "init", this).call(this),
          ...
          },
          {
            key: "resize",
            value: function () {
              void 0 === this.zoomViewer.rightSheetHeight &&
                ...
                m(P(a.prototype), "resize", this).call(this),
          ...
          },
          {
            ...
            value: function (e, t) {
              (this.skipCenterAnimation = !0),
                m(P(a.prototype), "exchangeTexture", this).call(this, e, t),
    ...
    (n.a.viewers = n.a.viewers || {}),
      (n.a.viewers.flipbook = function e(t, i) {
        return (
          ...
          !0 === t.is3D
            ? !0 === t.flat3D
              ? ((t.flexibility = 0), new C(t, i))
              : new d.a(t, i)
            : new p.a(t, i)
        );
      }),
      (n.a.viewers.default = n.a.viewers.reader = a.a),
      (n.a.viewers.slider = c);
  },
  ,
  ,
  function (e, t, i) {
    ...
    var g = n.a.utils,
      ...
      m = (function () {
        function e(t) {
          ...
          for (var i = 0; i < t.length; i++)
            (this.source[i] = g.httpsCorrection(t[i].toString())),
              this.pages.push(new v({ src: this.source[i] }));
        }
        return (
          f(e, [
            {
      ...
      b = (function (e) {
        ...
        function i(e, n) {
          ...
          var a = (o = t.call(this, e, n)).app,
            r = h(o);
          return (
            (r.document = new m(a.options.source)),
            ...
            { key: "dispose", value: function () {} },
            {
              ...
              value: function () {
                ...
                i.document.getPage(1).then(function (n) {
                  var o;
                  i.coverPage = n;
                  var a = (i.coverPage.viewPort = n._viewPort),
                    r = (i.coverPage.pageRatio = a.width / a.height),
                    s = r > 1;
                  (i.viewPorts[1] = a),
                    (e.dimensions.coverPage = {
                      ratio: r,
              ...
              value: function (e) {
                ...
                g.log("Requesting PDF Page:" + a),
                  i.document.getPage(a).then(function (a) {
                    ...
                    e.isFreshPage &&
                      (null === (r = t.viewer.getPageByNumber(e.pageNumber)) ||
                        void 0 === r ||
    ...
    n.a.providers.image = b;
    i(12);
    var w = (window.DFLIP = window.DEARFLIP = n.a);
    (w.defaults.viewerType = "flipbook"),
      (w.defaults.analyticsEventCategory = "Flipbook"),
      (w.defaults.analyticsViewerReady = "Book Ready"),
      (w.defaults.analyticsViewerOpen = "Open Book"),
      (w.defaults.analyticsViewerClose = "Book Closed"),
      (w.defaults.analyticsFirstPageChange = "First Page Flip"),
      (w.slug = "dflip"),
      (w.locationVar = "dFlipLocation"),
      (w.locationFile = "dflip"),
      (w.PAGE_MODE = { SINGLE: 1, DOUBLE: 2, AUTO: null }),
      (w.SINGLE_PAGE_MODE = { ZOOM: 1, BOOKLET: 2, AUTO: null }),
      (w.CONTROLSPOSITION = { HIDDEN: "hide", TOP: "top", BOTTOM: "bottom" }),
      (w.DIRECTION = { LTR: 1, RTL: 2 }),
      (w.PAGE_SIZE = { AUTO: 0, SINGLE: 1, DOUBLEINTERNAL: 2 }),
      (w.ConvertPageLinks = function () {
        for (
          var e,
            t = arguments[0] / 100,
            i = arguments[1] / 100,
        ...
        if (null != e && e.length > 0)
          for (var i = 0; i < e.length; i++)
            null != (t = e[i]) &&
              null != t[0] &&
              null == t[0].dest &&
              ((t = w.ConvertPageLinks.apply(this, t)), (e[i] = t));
        return e;
      }),
      (w.parseFallBack = function () {
        jQuery(".df-posts").addClass("dflip-books"),
          jQuery(".dflip-books").addClass("df-posts"),
      ...
      (w.parseBooks = function () {
        w.parseFallBack(), w.parseElements;
      });
    var P = function (e) {
      if (
        (null != e.source &&
        ...
        (e.has3DCover = o.a.isTrue(e.has3DCover)),
        void 0 !== e.pageSize &&
          ("1" === e.pageSize ||
          1 === e.pageSize ||
          e.pageSize === w.FLIPBOOK_PAGE_SIZE.SINGLE
            ? (e.pageSize = w.FLIPBOOK_PAGE_SIZE.SINGLE)
            : "2" === e.pageSize ||
              2 === e.pageSize ||
              e.pageSize === w.FLIPBOOK_PAGE_SIZE.DOUBLE_INTERNAL
            ? (e.pageSize = w.FLIPBOOK_PAGE_SIZE.DOUBLE_INTERNAL)
            : (e.pageSize = w.FLIPBOOK_PAGE_SIZE.AUTO)),
        void 0 !== e.pageMode &&
          ("1" === e.pageMode ||
          1 === e.pageMode ||
          e.pageMode === w.FLIPBOOK_PAGE_MODE.SINGLE
            ? (e.pageMode = w.FLIPBOOK_PAGE_MODE.SINGLE)
            : "2" === e.pageMode ||
              2 === e.pageMode ||
              e.pageMode === w.FLIPBOOK_PAGE_MODE.DOUBLE
            ? (e.pageMode = w.FLIPBOOK_PAGE_MODE.DOUBLE)
            : (e.pageMode = w.FLIPBOOK_PAGE_MODE.AUTO)),
        void 0 !== e.singlePageMode &&
          ("1" === e.singlePageMode ||
          1 === e.singlePageMode ||
          e.singlePageMode === w.FLIPBOOK_SINGLE_PAGE_MODE.ZOOM
            ? (e.singlePageMode = w.FLIPBOOK_SINGLE_PAGE_MODE.ZOOM)
            : "2" === e.singlePageMode ||
              2 === e.singlePageMode ||
              e.singlePageMode === w.FLIPBOOK_SINGLE_PAGE_MODE.BOOKLET
            ? (e.singlePageMode = w.FLIPBOOK_SINGLE_PAGE_MODE.BOOKLET)
            : (e.singlePageMode = w.FLIPBOOK_SINGLE_PAGE_MODE.AUTO)),
        void 0 !== e.controlsPosition &&
          "hide" === e.controlsPosition &&
          (e.controlsPosition = w.CONTROLS_POSITION.HIDDEN),
        void 0 !== e.overwritePDFOutline &&
          (e.overwritePDFOutline = o.a.isTrue(e.overwritePDFOutline)),
        void 0 !== e.webgl &&
          ((e.is3D = e.webgl = o.a.isTrue(e.webgl)), delete e.webgl),
        void 0 !== e.webglShadow &&
          ((e.has3DShadow = o.a.isTrue(e.webglShadow)), delete e.webglShadow),
        void 0 !== e.scrollWheel &&
          (o.a.isTrue(e.scrollWheel) &&
            (e.mouseScrollAction = w.MOUSE_SCROLL_ACTIONS.ZOOM),
          delete e.scrollWheel),
        void 0 !== e.stiffness && delete e.stiffness,
        void 0 !== e.soundEnable &&
          ((e.enableSound = o.a.isTrue(e.soundEnable)), delete e.soundEnable),
        void 0 !== e.enableDownload &&
          ((e.showDownloadControl = o.a.isTrue(e.enableDownload)),
          delete e.enableDownload),
        void 0 !== e.autoEnableOutline &&
          ((e.autoOpenOutline = o.a.isTrue(e.autoEnableOutline)),
          delete e.autoEnableOutline),
        void 0 !== e.autoEnableThumbnail &&
          ((e.autoOpenThumbnail = o.a.isTrue(e.autoEnableThumbnail)),
          delete e.autoEnableThumbnail),
        void 0 !== e.direction &&
          ("2" === e.direction ||
          2 === e.direction ||
          e.direction === w.READ_DIRECTION.RTL
            ? (e.readDirection = w.READ_DIRECTION.RTL)
            : (e.readDirection = w.READ_DIRECTION.LTR),
          delete e.direction),
        void 0 !== e.hard &&
        ...
        if (!0 !== e.linksparsed) {
          ...
          try {
            for (var i in e.links) {
              for (
                var n = e.links[i], a = [100, 100], r = 0;
                r < n.length;
                r++
              ) {
                for (
                  var s = n[r].substr(1).slice(0, -1).split(","), l = [], u = 0;
                  u < 5;
                  u++
                )
                  l[u] = s[u];
          ...
          e.links = w.parseLinks(t);
        }
      } else e.links = w.parseLinks(e.links);
      return o.a.sanitizeOptions(e);
    };
    jQuery.fn.extend({
      flipBook: function (e, t) {
        return (
          ...
          new n.a.Application(t)
        );
      },
    }),
      jQuery(document).ready(function () {
        var e = jQuery("body");
        w.executeCallback("onBeforeDearFlipInit"),
          void 0 !== window.dFlipWPGlobal &&
            jQuery.extend(!0, w.defaults, P(window.dFlipWPGlobal)),
          w.initUtils(),
          w.initControls(),
          e.on("click", ".df-element[data-lightbox]", function (e) {
            e.preventDefault(), w.openLightBox(jQuery(this));
          }),
          w.checkBrowserURLforDefaults(),
          w.parseCSSElements(),
          w.parseFallBack(),
          o.a.detectHash(),
          w.parseNormalElements(),
          w.checkBrowserURLforPDF(!0),
          w.openAttachmentLightBoxes(),
          w.executeCallback("onDearFlipInit");
      }),
      (o.a.finalizeOptions = function (e) {
        return P(e);
      }),
      (b.prototype.processAnnotations = function (e, t) {
        this.processCustomLinks(e, t);
      }),
      w.executeCallback("onDearFlipLoad");
    t.default = w;
  },
]);
