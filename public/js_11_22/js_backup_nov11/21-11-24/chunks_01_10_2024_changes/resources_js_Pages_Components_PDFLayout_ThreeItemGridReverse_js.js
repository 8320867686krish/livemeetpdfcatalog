"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_Pages_Components_PDFLayout_ThreeItemGridReverse_js"],{
...
/***/ "./resources/js/Pages/Components/PDFLayout/ThreeItemGridReverse.js":
/*!*************************************************************************!*\
  !*** ./resources/js/Pages/Components/PDFLayout/ThreeItemGridReverse.js ***!
  \*************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Header__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Header */ "./resources/js/Pages/Components/PDFLayout/Header.js");
/* harmony import */ var _ProductContentLayout__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ProductContentLayout */ "./resources/js/Pages/Components/PDFLayout/ProductContentLayout.js");
/* harmony import */ var _ProductImageLayout__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ProductImageLayout */ "./resources/js/Pages/Components/PDFLayout/ProductImageLayout.js");
/* harmony import */ var _Footer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Footer */ "./resources/js/Pages/Components/PDFLayout/Footer.js");
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../helper */ "./resources/js/Pages/helper.js");
...
var displayPerPageProduct = 3;

// Function to create rows with two columns
var DrawGridLayout = function DrawGridLayout() {
  var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var _data$configData = data.configData,
    configData = _data$configData === void 0 ? {} : _data$configData,
    _data$productItem = data.productItem,
    productItem = _data$productItem === void 0 ? [] : _data$productItem;
  var _configData$productPa = configData.productPageLayoutId,
    productPageLayoutId = _configData$productPa === void 0 ? '' : _configData$productPa,
    _configData$fontColor = configData.fontColor,
    fontColor = _configData$fontColor === void 0 ? "" : _configData$fontColor,
    _configData$backgroun = configData.backgroundColor,
    backgroundColor = _configData$backgroun === void 0 ? "" : _configData$backgroun,
    _configData$productBu = configData.productButtonEnabled,
    productButtonEnabled = _configData$productBu === void 0 ? "0" : _configData$productBu,
    _configData$priceAdju = configData.priceAdjustment,
    priceAdjustment = _configData$priceAdju === void 0 ? "" : _configData$priceAdju,
    _configData$productCh = configData.productChangeInPercentage,
    productChangeInPercentage = _configData$productCh === void 0 ? "" : _configData$productCh,
    _configData$productTa = configData.productTaxPercentage,
    productTaxPercentage = _configData$productTa === void 0 ? "" : _configData$productTa,
    _configData$productAt = configData.productAttributeValueColor,
    productAttributeValueColor = _configData$productAt === void 0 ? '' : _configData$productAt,
    _configData$productAt2 = configData.productAttributeAlignment,
    productAttributeAlignment = _configData$productAt2 === void 0 ? '' : _configData$productAt2,
    _configData$productAt3 = configData.productAttributes,
    productAttributes = _configData$productAt3 === void 0 ? '' : _configData$productAt3,
    _configData$productDe = configData.productDescriptionCharLimit,
    productDescriptionCharLimit = _configData$productDe === void 0 ? '' : _configData$productDe,
    _configData$productBa = configData.productBackgroundColor,
    productBackgroundColor = _configData$productBa === void 0 ? '' : _configData$productBa,
    _configData$productAt4 = configData.productAttributeLabelColor,
    productAttributeLabelColor = _configData$productAt4 === void 0 ? '' : _configData$productAt4;
  var rows = [];
  var j = 1;
  var emptyItems = displayPerPageProduct - productItem.length;
  if (emptyItems > 0) {
    for (var k = 0; k < emptyItems; k++) {
      productItem.push({});
    }
  }
  for (var i = 0; i < productItem.length; i += 3) {
    rows.push( /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.Fragment, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
          ...
          children: productItem.slice(i, i + 2).map(function (pItem) {
            ...
            return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
              children: Object.keys(pItem).length > 0 ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
                ...
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
                  ...
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_ProductImageLayout__WEBPACK_IMPORTED_MODULE_3__["default"], {
                    productImage: image,
                    productAttributes: productAttributes,
                    barcode: barcode
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_ProductContentLayout__WEBPACK_IMPORTED_MODULE_2__["default"], {
            ...
            }, "column_key_".concat(id !== undefined ? id : Math.pow(2, ++j)));
          })
        })
      }, "product_".concat(i / 2)), Object.keys(productItem[2]).length > 0 ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
        className: "row",
        style: {
          height: "14.85cm",
          margin: "10px 5px",
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_ProductImageLayout__WEBPACK_IMPORTED_MODULE_3__["default"], {
            productImage: productItem[2]['image'] === '' || productItem[2]['image'] === null ? "".concat(IMAGE_PREFIX, "images/no_image.png") : productItem[2]['image'],
            productAttributes: productAttributes,
            barCode: productItem[2]['barCode']
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_ProductContentLayout__WEBPACK_IMPORTED_MODULE_2__["default"], {
            valueColor: productAttributeValueColor,
            productPageLayoutId: productPageLayoutId,
            fontColor: fontColor,
            ...
            productAttributes: productAttributes,
            descriptionCharLimit: productDescriptionCharLimit,
            productData: productItem[2]
          })]
        })
      }, "product_".concat(Math.pow(i, ++j))) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
        className: "row",
        style: {
          height: "14.85cm",
          marginTop: "10px"
...
var ThreeItemGridReverse = function ThreeItemGridReverse(props) {
  var _props$innerPagePaddi = props.innerPagePadding,
    ...
    _props$configData3 = props.configData,
    configData = _props$configData3 === void 0 ? {} : _props$configData3;
  var pageArray = (0,_helper__WEBPACK_IMPORTED_MODULE_5__.objectTo2DArray)(selectedProducts, displayPerPageProduct);
  var pageSize = 1;
    ...
    children: pageArray.map(function (productItem, pageIndex) {
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
          ...
          children: [(headerText != '' || logo !== '') && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_Header__WEBPACK_IMPORTED_MODULE_1__["default"], {
            ...
            className: "container",
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(DrawGridLayout, {
              configData: configData,
              productItem: productItem
            })
          }), (footerText != '' || footerPageNoEnabled == '1' || footerDateEnabled == '1') && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_Footer__WEBPACK_IMPORTED_MODULE_4__["default"], {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ThreeItemGridReverse);
